...
class IndexControllerTest {
    ...
    void whenGetIndexPageExpectModelAttributeThenOk() throws JsonProcessingException {
        ...
        var profileDTO1 = new ProfileDTO(1, "user1", "5 years", 1, Calendar.getInstance(), Calendar.getInstance());
        var profileDTO2 = new ProfileDTO(2, "user2", "2 years", 2, Calendar.getInstance(), Calendar.getInstance());
        var expectedProfiles = Map.of(
                firstInterview.getId(), profileDTO1,
                secondInterview.getId(), profileDTO2
        );
        ...
        when(profilesService.getProfileById(firstInterview.getSubmitterId())).thenReturn(Optional.of(profileDTO1));
        when(profilesService.getProfileById(secondInterview.getSubmitterId())).thenReturn(Optional.of(profileDTO2));
